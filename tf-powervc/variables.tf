...
variable "assisted_url" {
  description = "Assisted service API access point"
  default     = "https://api.openshift.com/api/assisted-install/v2"
}

variable "assisted_token" {
  description = "The token can be downloaded from your RedHat account, find it at bottom of the Download page"
  default     = ""
}

variable assisted_ocp_version {
  description = " The OCP version to install"
  default = "4.14"
}
...
variable "openshift_rhcos_iso" {
  default = "https://mirror.openshift.com/pub/openshift-v4/ppc64le/dependencies/rhcos/latest/rhcos-live.ppc64le.iso"
}

variable "openshift_rhcos_kernel" {
  default = "https://mirror.openshift.com/pub/openshift-v4/ppc64le/dependencies/rhcos/latest/rhcos-installer-kernel-ppc64le"
}

variable "openshift_rhcos_initramfs" {
  default = "https://mirror.openshift.com/pub/openshift-v4/ppc64le/dependencies/rhcos/latest/rhcos-installer-initramfs.ppc64le.img"
}

variable "openshift_rhcos_rootfs" {
  default = "https://mirror.openshift.com/pub/openshift-v4/ppc64le/dependencies/rhcos/latest/rhcos-installer-rootfs.ppc64le.img"
}
